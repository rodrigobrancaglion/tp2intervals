...
import org.freekode.tp2intervals.integration.platform.trainingpeaks.token.TPTokenRepository
...
class TPApiClientConfig(
    private val TPTokenRepository: TPTokenRepository,
    private val objectMapper: ObjectMapper,
) {
    @Bean
    fun requestInterceptor(): RequestInterceptor {
        return RequestInterceptor { template ->
            val token = TPTokenRepository.getToken()
