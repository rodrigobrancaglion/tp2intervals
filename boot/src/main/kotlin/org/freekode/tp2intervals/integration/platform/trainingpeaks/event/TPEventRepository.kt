...
@Repository
class TPEventRepository(
    private val TPEventApiClient: TPEventApiClient,
    ...
    override fun getEvents(startDate: LocalDate, endDate: LocalDate): List<Event> {
        ...
        val tpEvents = TPEventApiClient.getEvents(userId, startDate.toString(), endDate.toString())
    ...
    override fun saveEvents(events: List<Event>) {
        ...
        val existingIcuIds = TPEventApiClient.getEvents(userId, minDate.toString(), maxDate.toString())
        ...
        newEvents.forEach { event ->
            try {
                ...
                TPEventApiClient.createEvent(userId, tpDto)
            } catch (e: Exception) {
