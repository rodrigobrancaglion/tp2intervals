...
class IcuTargetConverter(
    private val ftp: Double?,
    private val lthr: Double?,
    private val paceThreshold: Double?
) {
    fun toMainTarget(stepDTO: IcuWorkoutDocDTO.WorkoutStepDTO): StepTarget {
        return when {
    ...
    fun toCadenceTarget(stepValueDTO: IcuWorkoutDocDTO.StepValueDTO): StepTarget {
    ...
    private fun mapSimpleUnit(
        ...
        resolvedStepValueDTO: IcuWorkoutDocDTO.ResolvedStepValueDTO
    ): StepTarget {
     ...
     */
    private fun mapAbsolutePower(power: IcuWorkoutDocDTO.StepValueDTO?): StepTarget {
