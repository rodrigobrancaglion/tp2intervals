...
class IntervalsConfigurationRepository(
    ...
    fun getConfiguration(): IntervalsConfigurationDTO {
        val config = iConfigurationRepository.getConfigurationByPrefix(platform().key)
        return IntervalsConfigurationDTO(config)
    }
    ...
    private fun validateConfiguration(newConfig: Map<String, String?>) {
        val intervalsConfig: IntervalsConfigurationDTO
        try {
            intervalsConfig = IntervalsConfigurationDTO(newConfig)
